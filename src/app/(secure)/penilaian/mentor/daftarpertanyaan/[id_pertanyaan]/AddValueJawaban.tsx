...
const AddValueJawaban: React.FC<ModalProps> = ({ onSubmit, idPertanyaan }) => {
  ...
  const handleFormSubmit: SubmitHandler<any> = async (data) => {
    ...
    try {
      ...
      await axiosCustom
        .post(`/tenant-nilai-mentor/pertanyaan-opsi/${idPertanyaan}`, {
          value: data.valueJ,
        })
        .then((response) => {
      ...
      >
        ...
        <ModalContent>
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            <ModalHeader>Tambah Value Jawaban</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
...
export default AddValueJawaban;
