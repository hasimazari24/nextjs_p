...
const DeleteHasilPenilaian = ({ dataDelete, onSubmit }: deleteProps) => {
    ...
    if (dataDelete.id) {
      ...
      try {
        ...
        const response = await axiosCustom.delete(
          `/tenant-nilai-mentor/${dataDelete?.id}`,
        );
  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        dataConfirm={`Yakin ingin hapus nilai mentor : ${dataDelete?.fullname} ?`}
...
export default DeleteHasilPenilaian;
