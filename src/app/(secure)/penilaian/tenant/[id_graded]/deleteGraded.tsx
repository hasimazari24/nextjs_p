...
const DeleteGraded = ({ dataDelete, onSubmit }: deleteProps) => {
    ...
    if (dataDelete.id) {
      ...
      try {
        ...
        const response = await axiosCustom.delete(
          `/delete-general-grades-tenant/${dataDelete?.id}`,
        );
  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        dataConfirm={`Yakin ingin hapus penilaian dengan aspek : ${dataDelete?.aspek_penilaian} ?`}
