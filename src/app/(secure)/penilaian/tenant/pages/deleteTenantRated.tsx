...
const DeleteTenantRated = ({ dataDelete, onSubmit }: deleteProps) => {
    ...
    if (dataDelete.id) {
      ...
      try {
        ...
        const response = await axiosCustom.delete(
          `/delete-tenant-togeneral-grades-tenant/${dataDelete?.tenant_id}`,
        );
  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        dataConfirm={`Yakin ingin hapus tenant : ${dataDelete?.tenant_name} ?`}
...
export default DeleteTenantRated;
