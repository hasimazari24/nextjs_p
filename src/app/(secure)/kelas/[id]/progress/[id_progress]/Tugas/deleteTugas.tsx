...
const DeleteTugas: React.FC<deleteProps> = ({ dataDelete, onSubmit }) => {
    ...
    if (dataDelete) {
      ...
      try {
        ...
        const response = await axiosCustom.delete(
          `/delete-course-item-assigment/${dataDelete?.id}`,
        );
  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        dataConfirm={`Yakin ingin hapus Tugas : ${dataDelete?.title} ?`}
