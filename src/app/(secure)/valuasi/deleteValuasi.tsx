...
const DeleteValuasi = ({ dataDelete, onSubmit }: deleteProps) => {
  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        dataConfirm={`Yakin ingin hapus valuasi : ${dataDelete?.valuasi} ?`}
