...
const DeleteGroupKuesioner = ({ dataDelete, onSubmit }: deleteProps) => {
    ...
    if (dataDelete.id) {
      ...
      try {
        ...
        const response = await axiosCustom.delete(
          `/header-pertanyaan-group/${dataDelete?.id}/delete`,
        );
  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        dataConfirm={`Yakin ingin hapus grub ini : ${dataDelete?.title} ?`}
