    ...
    import { Box, Text, Stack, Container, Image, Drawer, DrawerOverlay, DrawerBody, DrawerHeader, DrawerContent, DrawerCloseButton, HStack } from "@chakra-ui/react";
    ...
    const CardGallery = ({image, judul, deskripsi, tgl, tgl_format}: GalleryCardProps) => {
